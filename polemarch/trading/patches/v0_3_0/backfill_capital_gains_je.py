...
To run manually:
    ...
    bench --site <site> execute polemarch.trading.patches.v0_3_0.backfill_capital_gains_je.execute
...
def execute(from_date: str | None = None, dry_run: bool = False):
    if not frappe.db.exists(
        ...
        frappe.log_error(
            ...
            "polemarch.trading.patches.v0_3_0.add_custom_fields_to_je first.",
